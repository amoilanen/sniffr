...
Just rebuild Sniffr and restart the examples:
...
# Back in Express terminal: no need to restart, just test again
curl http://localhost:3000/detect-hardcoded
```
...
- Examples use local Sniffr (file:../../) for immediate testing
